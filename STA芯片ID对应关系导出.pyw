...
class MyMainWindow(QMainWindow, Ui_STA_database_query):
    def __init__(self):
        ...
        self.sql_driver = r'DRIVER={Microsoft Access Driver (*.mdb, *.accdb)};DBQ=E:\Python\GUI_project\Equip_sta.mdb;'
        # 创建数据库连接对象
        ...
        self.sqlstring = r"""SELECT ucTestRet,stVersion_two,ucChipIdStr,ucModuleIdStr,OperDate,OperTime FROM Equip_sta.mdb.equip_sta where ucChipIdStr<>'' and OperDate>=? and OperTime>=? order by OperDate,OperTime asc;"""
    ...
    def click_query(self):
        ...
        # 自动设置ID倒数5个字符
        self.lineEdit.setText(self.cur.fetchall()[0][2][-5:])
    ...
    def export_id_to_excel(self):
        ...
        path_name = os.path.join(
            r"C:\Users\zhoum\Desktop\ID清单，请手下留情，勿删！！！", wo1)
        # 新建工作簿
